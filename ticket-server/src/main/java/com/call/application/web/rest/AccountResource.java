...
import com.call.application.email.NotificationService;
...
import com.call.application.web.rest.errors.ParameterizedErrorVM;
import com.call.application.web.rest.vm.KeyAndPasswordVM;
...
public class AccountResource {
    ...
    public AccountResource(UserRepository userRepository, UserService userService,NotificationService notificationService) {
    ...
    public ResponseEntity<?> registerAccount(@Valid @RequestBody ManagedUserVM managedUserVM) {
        ...
        return userRepository.findOneByUsername(managedUserVM.getUsername().toLowerCase())
            ...
            .orElseGet(() -> userRepository.findOneByEmail(managedUserVM.getEmail())
                ...
                .orElseGet(() -> {
                    userService.createUser(managedUserVM.getUsername(), managedUserVM.getPassword(),
                            managedUserVM.getFirstname(), managedUserVM.getLastname(),
                            managedUserVM.getEmail().toLowerCase(), managedUserVM.getImageUrl(), managedUserVM.getLangKey());
                   
//                 try {
//                	   notificationService.sendNotification(managedUserVM);
...
//				}
    ...
    public ResponseEntity<?> saveAccount(@Valid @RequestBody UserDTO userDTO) {
        ...
        if (existingUser.isPresent() && (!existingUser.get().getUsername().equalsIgnoreCase(userDTO.getUsername()))) {
            return ResponseEntity.badRequest().body(new ParameterizedErrorVM("Email is already in use", userDTO.getEmail()));
        }
        return userRepository
            .findOneByUsername(SecurityUtils.getCurrentUsername())
            .map(u -> {
