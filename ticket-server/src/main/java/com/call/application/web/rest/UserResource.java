...
import com.call.application.web.rest.util.HeaderUtil;
import com.call.application.web.rest.util.PaginationUtil;
import com.call.application.web.rest.util.ResponseUtil;
...
public class UserResource {
    ...
    public ResponseEntity<UserDTO> updateUser(@RequestBody ManagedUserVM managedUserVM) {
        ...
        return ResponseUtil.wrapOrNotFound(updatedUser,
            HeaderUtil.createAlert("A user is updated with identifier " + managedUserVM.getUsername(), managedUserVM.getUsername()));
    }
